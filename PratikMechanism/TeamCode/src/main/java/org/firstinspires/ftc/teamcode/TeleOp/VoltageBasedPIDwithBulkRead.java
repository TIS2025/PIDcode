...
//import org.firstinspires.ftc.teamcode.Subsystems.VoltageBasedPID_BulkRead;
//
//@Config
//@TeleOp(name = "PID Bulk Mode Compare", group = "Teleop")
//public class VoltageBasedPIDwithBulkRead extends LinearOpMode {
//
//    public static BotHardware robot = BotHardware.getInstance();
//    private VoltageBasedPID_BulkRead vb;
...
//        vb = new VoltageBasedPID_BulkRead(robot);
...
//
//        while (opModeInInit()) {
//            vb.setUseBulkRead(true);
//            vb.updatePivotState(VoltageBasedPID_BulkRead.PivotState.INIT);
//            vb.updateExtensionState(VoltageBasedPID_BulkRead.ExtensionState.INIT);
//            vb.updateElbowState(VoltageBasedPID_BulkRead.ElbowState.INIT);
//            vb.updateClawState(VoltageBasedPID_BulkRead.ClawState.INIT);
//            vb.updateWristState(VoltageBasedPID_BulkRead.WristState.INIT);
//            vb.update();
//
...
//            }
//
//            vb.setUseBulkRead(useBulk);  // updated from setUseBulkClear()
//            vb.update(); // still keep this in case
//
//            ftc = updateAction();
...
//                                new InstantAction(() -> vb.updatePivotState(VoltageBasedPID_BulkRead.PivotState.SAMPLE_PRE_PICK)),
//                                new SleepAction(0.5),
//                                new InstantAction(() -> vb.updateExtensionState(VoltageBasedPID_BulkRead.ExtensionState.SAMPLE_PICK)),
//                                new SleepAction(1),
//                                new InstantAction(() -> vb.updateElbowState(VoltageBasedPID_BulkRead.ElbowState.INTAKE)),
//                                new InstantAction(() -> vb.updateWristState(VoltageBasedPID_BulkRead.WristState.SAMPLE_PICK)),
//                                new InstantAction(() -> vb.updateClawState(VoltageBasedPID_BulkRead.ClawState.OPEN)),
//                                new SleepAction(0.1)
//                        )
//                ));
//            }
...
//                        new ArmPIDUpdater(arm),
//                        new SequentialAction(
//                                new InstantAction(() -> vb.updatePivotState(VoltageBasedPID_BulkRead.PivotState.SAMPLE_PICK)),
//                                new SleepAction(0.5),
//                                new InstantAction(() -> vb.updateClawState(VoltageBasedPID_BulkRead.ClawState.CLOSE)),
//                                new SleepAction(1),
//                                new InstantAction(() -> vb.updatePivotState(VoltageBasedPID_BulkRead.PivotState.SAMPLE_PRE_PICK)),
//                                new InstantAction(() -> vb.updateWristState(VoltageBasedPID_BulkRead.WristState.SAMPLE_DROP)),
//                                new InstantAction(() -> vb.updateElbowState(VoltageBasedPID_BulkRead.ElbowState.INIT)),
//                                new SleepAction(0.5),
//                                new InstantAction(() -> vb.updateExtensionState(VoltageBasedPID_BulkRead.ExtensionState.INIT))
//                        )
//                ));
//            }
//
...
//                                new SleepAction(0.5),
//                                new InstantAction(() -> vb.updateExtensionState(VoltageBasedPID_BulkRead.ExtensionState.INIT)),
//                                new InstantAction(() -> vb.setPivotTarget(-1600))
//                        )
//                ));
//            }
//
...
//                        new InstantAction(() -> vb.updateExtensionState(VoltageBasedPID_BulkRead.ExtensionState.INIT)),
//                        new InstantAction(() -> vb.setPivotTarget(-1600)),
//                        new InstantAction(() -> vb.updateExtensionState(VoltageBasedPID_BulkRead.ExtensionState.SAMPLE_DROP)),
//                        new SleepAction(1.5),
//                        new InstantAction(() -> vb.updateElbowState(VoltageBasedPID_BulkRead.ElbowState.BASKET_DROP)),
//                        new InstantAction(() -> vb.updateWristState(VoltageBasedPID_BulkRead.WristState.SAMPLE_DROP)),
//                        new SleepAction(0.5),
//                        new InstantAction(() -> vb.updateClawState(VoltageBasedPID_BulkRead.ClawState.OPEN)),
//                        new SleepAction(1),
